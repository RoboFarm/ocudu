...
ocudu::create_e2_cu_cp_agent(const e2ap_config&                                 e2ap_cfg_,
                             ...
                             std::unique_ptr<e2_node_component_config_provider> node_component_config_provider_)
{
  ...
  if (e2ap_cfg_.e2sm_rc_enabled) {
    ...
    auto rc_control_action_executor = std::make_unique<e2sm_rc_control_action_3_1_cu_executor>(cu_configurator_);
