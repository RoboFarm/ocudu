...
{
  // Save reference of the segmenter buffer.
  ...
  scrambler->advance(segment_buffer->get_cb_metadata(start_i_cb_).cb_specific.cw_offset);

  // Store the codeword-specific parameters.
