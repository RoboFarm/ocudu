...
static constexpr unsigned NSHIFTS = pucch_constants::f1::NOF_ICS;
                               ...
                               const pucch_format1_map<unsigned>&           mux_nof_harq_ack)
{
  ...
  static_vector<hop_contribution_mux, NSHIFTS * pucch_constants::f1::NOF_TD_OCC> metrics_hop0(0);
  static_vector<hop_contribution_mux, NSHIFTS * pucch_constants::f1::NOF_TD_OCC> metrics_hop1(0);
